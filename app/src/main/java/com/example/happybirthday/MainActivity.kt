        ...
        setContent {
            HappyBirthdayTheme {
                ...
                Surface(
                    ...
                    BirthdayGreetingWithText(message = "Happy Birthday Sam!", from = "- From Om")
                }
            }
        }
    }
...
fun BirthdayGreetingWithImagePreview() {
    HappyBirthdayTheme {
        BirthdayGreetingWithImage(message = stringResource(R.string.happy_birthday_text), from = "- From Om")
